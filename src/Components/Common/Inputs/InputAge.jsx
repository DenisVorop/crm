const InputAge = ({ label, nameRef, onChangeInput }) => {
    return (
        <div className="patient-filter__number" style={{ marginLeft: '-45px' }}>
            ...
            <input type="text" placeholder='18' style={{ width: '53px', paddingLeft: '9px', marginRight: '10px' }} />
            <div style={{ marginRight: '10px', fontSize: '18px' }}>до</div>
            <input type="text" placeholder='65' style={{ width: '53px', paddingLeft: '9px', marginRight: '10px' }} />
        </div>
    )
}
